...
def _():
    mo.md(r"""
    The raw ecg signals have more than 12 columns.  I, II, III, aVR,aVL, aVF and V1-6 have no NAN values while the rest do?  What do those values correspond to?
    """)
    return
